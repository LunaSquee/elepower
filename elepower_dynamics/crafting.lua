...
-- Tools --
-----------
if epi.iron_ingot == "" and ept.enable_iron_tools == true then
...
if ept.enable_lead_tools == true then
    minetest.register_craft({
...
minetest.register_craft({
    ...
    recipe = {
        "elepower_dynamics:wood_dust", "elepower_dynamics:wood_dust",
        "elepower_dynamics:wood_dust", "elepower_dynamics:wood_dust"
    }
})
...
minetest.register_craft({
    ...
    recipe = {
        {"", "elepower_dynamics:lead_plate", ""}, {
            "elepower_dynamics:lead_plate", "elepower_dynamics:conduit",
            "elepower_dynamics:lead_plate"
        }, {"", "elepower_dynamics:lead_plate", ""}
    }
})
...
if ele.external.conduit_dirt_with_grass == true then
    minetest.register_craft({
        ...
        recipe = {
            {"", epi.seed_wheat, ""}, {"", "elepower_dynamics:conduit", ""},
            {"", epi.dirt, ""}
        }
    })
end
...
if ele.external.conduit_dirt_with_dry_grass == true then
    minetest.register_craft({
        ...
        recipe = {
            {"", epi.wheat, ""}, {"", "elepower_dynamics:conduit", ""},
            {"", epi.dirt, ""}
        }
    })
end
...
if ele.external.conduit_stone_block == true then
    minetest.register_craft({
        ...
        recipe = {
            ...
            {
                epi.slab_stone_block, "elepower_dynamics:conduit",
                epi.slab_stone_block
            }, {"", epi.slab_stone_block, ""}
        }
    })
    ...
    minetest.register_craft({
        ...
        recipe = {
            {"", epi.slab_desert_stone_block, ""}, {
                epi.slab_desert_stone_block, "elepower_dynamics:conduit",
                epi.slab_desert_stone_block
            }, {"", epi.slab_desert_stone_block, ""}
        }
    })
...
minetest.register_craft({
    ...
    recipe = {
        {"", "basic_materials:copper_wire", ""}, {
            "basic_materials:copper_wire", "elepower_dynamics:iron_ingot",
            "basic_materials:copper_wire"
        }, {"", "basic_materials:copper_wire", ""}
    },
    replacements = {
...
minetest.register_craft({
    ...
    recipe = {
        {"", "basic_materials:silver_wire", ""}, {
            "basic_materials:silver_wire", "elepower_dynamics:zinc_ingot",
            "basic_materials:silver_wire"
        }, {"", "basic_materials:silver_wire", ""}
    },
    replacements = {
...
minetest.register_craft({
    ...
    recipe = {
        {"", "elepower_dynamics:wound_copper_coil", ""}, {
            "elepower_dynamics:fluid_duct", "elepower_dynamics:fluid_duct",
...
minetest.register_craft({
    ...
    recipe = {
        {"elepower_dynamics:steel_ingot", "elepower_dynamics:steel_ingot", "elepower_dynamics:steel_ingot"},
...
minetest.register_craft({
    ...
    recipe = {
        ...
        {
            epi.mese_crystal_fragment, epi.group_color_black,
            epi.mese_crystal_fragment
...
minetest.register_craft({
    ...
    recipe = {
        {"", "elepower_dynamics:copper_plate", ""}, {
            epi.mese_crystal_fragment, epi.mese_crystal_fragment,
            epi.mese_crystal_fragment
...
minetest.register_craft({
    ...
    recipe = {
        ...
        {
            "elepower_dynamics:electrum_gear", "elepower_dynamics:servo_valve",
            "elepower_dynamics:electrum_gear"
...
minetest.register_craft({
    ...
    recipe = {
        {
            "elepower_dynamics:zinc_dust", "elepower_dynamics:graphite_rod",
            "elepower_dynamics:lead_dust"
        }, {
            "elepower_dynamics:tin_plate", epi.mese_crystal_fragment,
...
minetest.register_craft({
    ...
    recipe = {
        ...
        {
            epi.silver_ingot, "elepower_dynamics:wound_copper_coil",
            epi.silver_ingot
        }, {"", epi.mese_lamp, ""}
    }
})
...
minetest.register_craft({
    ...
    recipe = {
        {epi.glass, epi.glass, epi.glass}, {
            epi.group_color_blue, "elepower_dynamics:silicon_wafer_doped",
            epi.group_color_blue
        }, {
            epi.mese_crystal_fragment, "elepower_dynamics:wound_copper_coil",
            epi.mese_crystal_fragment
        }
    }
})
...
minetest.register_craft({
    ...
    recipe = {
        {
            "elepower_dynamics:chip", "elepower_dynamics:chip",
            "elepower_dynamics:chip"
        }, {
            "elepower_dynamics:capacitor", "elepower_dynamics:pcb",
            "elepower_dynamics:capacitor"
        }, {epi.copper_ingot, epi.mese_crystal, epi.copper_ingot}
    }
})
...
minetest.register_craft({
    ...
    recipe = {
        {"elepower_dynamics:tin_plate", ""}, {"", "elepower_dynamics:tin_plate"}
    }
})
...
for mat, data in pairs(elepd.registered_gears) do
    for _, keyword in ipairs(keywords) do
        ...
        if found then
            ...
            minetest.register_craft({
                recipe = {{"", found, ""}, {found, "", found}, {"", found, ""}},
                output = data.item
            })
...
local function blockcraft(mat)
    ...
    minetest.register_craft({
        type = "shapeless",
        output = block,
        recipe = {ingot, ingot, ingot, ingot, ingot, ingot, ingot, ingot, ingot}
    })
